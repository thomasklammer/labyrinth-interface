...
import edu.mci.management.api.generated.controller.ServersApi;
...
public class ServerController implements ServersApi {
    ...
    public ResponseEntity<GameServer> createServer(GameServerRegistration request) {
        ...
        log.info("Creating GameServer received: Name='{}', URI='{}', MaxPlayers={}", request.getName(), request.getUri(), request.getMaxPlayers());
        var gameServer = serverMapper.toDomain(request);
        var createdServer = serverService.create(gameServer);
        log.info("GameServer created: Id='{}', Name='{}', URI='{}', MaxPlayers={}, Status='{}', LastSeen='{}'", createdServer.getId(), createdServer.getName(), createdServer.getUri(), createdServer.getMaxPlayers(), createdServer.getStatus(), createdServer.getLastSeen());
    ...
    public ResponseEntity<GameServer> updateServer(UUID serverId, GameServerUpdate request) {
        log.info("Update GameServer received: Id='{}', Status='{}', CurrentPlayerCount='{}'", serverId, request.getStatus(), request.getCurrentPlayerCount());
        var updatedGameServer = serverService.updateHeartbeat(serverId, request);
        var responseDto = serverMapper.toDto(updatedGameServer);
        log.info("GameServer updated: Id='{}', Name='{}', URI='{}', MaxPlayers={}, Status='{}', LastSeen='{}'", updatedGameServer.getId(), updatedGameServer.getName(), updatedGameServer.getUri(), updatedGameServer.getMaxPlayers(), updatedGameServer.getStatus(), updatedGameServer.getLastSeen());
